...
{
    public static CountryDto ToDto(this Realestate.Domain.Entities.World.Country src)
    {
    ...
    public static Realestate.Domain.Entities.World.Country ToEntity(this CreateCountryDto src)
    {
        if (src == null) return null!;
        return new Realestate.Domain.Entities.World.Country
        {
            Name = src.Name,
            IsoTwo = src.IsoTwo,
            IsoThree = src.IsoThree,
    ...
    public static void UpdateFrom(this Realestate.Domain.Entities.World.Country target, UpdateCountryDto src)
    {
